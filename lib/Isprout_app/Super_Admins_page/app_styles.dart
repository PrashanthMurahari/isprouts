...
class AppStyles {
  ...
  static DateTime? jdp(String? dateTime) => dateTime == null ? null : DateFormat.yMMMMEEEEd().parse(dateTime);

  static String? jd(DateTime? dateTime) => dateTime == null ? null : DateFormat.yMMMMEEEEd().format(dateTime);
  static String? jds(DateTime? dateTime) => dateTime == null ? null : DateFormat.yMMMMd().format(dateTime);
  static String? jt(DateTime? dateTime) => dateTime == null ? null : DateFormat('hh:mm aaa').format(dateTime);
  static DateTime? jtp(String? dateTime) => dateTime == null ? null : DateFormat('hh:mm aaa').parse(dateTime);
  static DateTime? jmp(String? dateTime) => dateTime == null ? null : DateFormat('MMMM, yyyy').parse(dateTime);

  static String? fd(DateTime? dateTime) => dateTime == null ? null : DateFormat('MMM dd, hh:mm aaa').format(dateTime);
  static String? fm(DateTime? dateTime) => dateTime == null ? null : DateFormat('MMMM, yyyy').format(dateTime);

  static DateTime? fdp(String? dateTime) => dateTime == null ? null : DateFormat.yMMMMEEEEd().add_jm().parse(dateTime);
